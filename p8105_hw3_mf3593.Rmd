...
The histogram describes data value distribution for responses at different locations in NY in the year 2006 and 2010. The x-axis depicts different `Location` and y-axis is `Data Value`. According to the graph `Data Value distribution for response in NY`, there is no record of distribution of data value among responses in 2016 at location Bronx County, Erie County and Monroe County which are included in 2010. 2010 has slightly higher data value for the reponse `very good` across different locations compared to year 2006. Overall, response `very good` and `good` have the highest data values and `poor` has the lowest data values in NY state in both year 2006 and 2010. 
